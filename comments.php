...
//Since this is a development environment in XAMPP, we are using 'root' user with no password
 ...
 $dsn = 'mysql:host=localhost;dbname=comments@app';
 $dbuser = 'root';
 $dbpass = '';
...
else
{
	...
	if($comments != NULL){
		...
		foreach($comments as $row){
			...
			$commentList .= "<p>Name: $name email: $email Date: $posted_date <a href = 'comments.php?action=edit&id=$id'>edit</a> | <a href = 'comments.php?action=delete&id=$id'>delete</a></p><p>$comment</p><hr>";
		}		
	}
	else
